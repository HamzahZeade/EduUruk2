...
namespace EduUruk.Services.Utilities
{
    public static class AppExtentionsMethods
    {
        ...
        public static string GetArabicDayName(this DateTime date)
        {
            CultureInfo arabicCulture = new CultureInfo("ar-SA");
            return arabicCulture.DateTimeFormat.GetDayName(date.DayOfWeek);
        }

        public static string GetRepatTaskName(this string name)
        {
            string TaskName = "  مهمة مدوره ";
