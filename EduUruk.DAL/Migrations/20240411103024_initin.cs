...
{
    public partial class initin : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArabicGroupName = table.Column<string>(type: "nvarchar(35)", maxLength: 35, nullable: false),
                    EnglishGroupName = table.Column<string>(type: "nvarchar(65)", maxLength: 65, nullable: false),
                    GroupIco = table.Column<string>(type: "nvarchar(45)", maxLength: 45, nullable: false),
                    PageGroupIndex = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatdTime = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArabicPageName = table.Column<string>(type: "nvarchar(35)", maxLength: 35, nullable: false),
                    EnglishPageName = table.Column<string>(type: "nvarchar(35)", maxLength: 35, nullable: false),
                    PageURL = table.Column<string>(type: "nvarchar(65)", maxLength: 65, nullable: false),
                    Ico = table.Column<string>(type: "nvarchar(45)", maxLength: 45, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolePermission", x => new { x.PageID, x.RoleId });
                    table.ForeignKey(
